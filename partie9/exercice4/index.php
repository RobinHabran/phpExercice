        ...
        <div class="col-md-8 offset-md-2">
          ...
          <div class="row answer">
            ...
            <div class="col-md-6 offset-md-3 text-center answer">
              ...
              <p>Le timestamp du <span class="bold"><?= $objectifDate ?></span> est de <?= formatTimestamp(mktime('15', '00', '00', '8', '2', '2016')); ?></p>
              <p>Le timestamp du <span class="bold"><?= $objectifDate ?></span> est de <?= mktime('15', '00', '00', '8', '2', '2016'); ?> secondes</p>
